...
export class BudEngine extends EngineUtils {
  ...
  protected renderPartHierarchy(
    ...
    // Create data object from instance properties
    ...
    this.renderPartHierarchyWithData(
      partId,
 ...
 // Calculate vector from attachment point to mouse in bone's local space
  ...
  protected endBoneDrag() {
    // Don't clear activePartId here - it should persist for selection
    // Only clear drag-related state
    this.isDragging = false
  }
